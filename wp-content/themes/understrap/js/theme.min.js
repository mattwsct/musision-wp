...
!(function (t, e) {
    ...
    g = (function () {
      ...
      return (
        ...
        (t._destroyElement = function (t) {
          p(t).detach().trigger(u.CLOSED).remove();
        }),
      ...
      return (
        ...
        (t._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var n = function (t) {
                e._pointerEvent && st[t.originalEvent.pointerType.toUpperCase()]
  ...
  p(document).on(pt.CLICK_DATA_API, wt, function (t) {
    ...
    (p.fn[lt].noConflict = function () {
      return (p.fn[lt] = ht), Ct._jQueryInterface;
    });
  for (
  ...
  function Ft(t, e) {
    ...
    if ((t !== s && e !== s) || i.contains(o))
      return (function (t) {
        var e = t.nodeName;
        return "BODY" !== e && ("HTML" === e || jt(t.firstElementChild) === t);
      })(s)
        ? s
        : jt(s);
    var a = Rt(t);
      ...
      modifiers: {
              ...
              y.forEach(function (t, e) {
                ...
                (r || u || f) &&
                  ...
                  (d.offsets.popper = Qt(
                    {},
                    d.offsets.popper,
                    ee(d.instance.popper, d.offsets.reference, d.placement)
                  )),
                  (d = ie(d.instance.modifiers, d, "flip")));
              }),
              d
            );
          },
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            return (
              (t.attributes = Qt({}, v, t.attributes)),
        ...
        applyStyle: {
          ...
          onLoad: function (t, e, n, i, o) {
            ...
            return (
              ...
              ue(e, { position: n.positionFixed ? "fixed" : "absolute" }),
              n
            );
          },
      ...
      return (
        ...
        (c._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, e)), p(this).data(Ce, t)),
              "string" == typeof n)
            ) {
              if (void 0 === t[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  var Ge = "modal",
    ...
    gn = (function () {
      function o(t, e) {
        (this._config = this._getConfig(e)),
          (this._element = t),
          (this._dialog = t.querySelector(un)),
          (this._backdrop = null),
          (this._isShown = !1),
        ...
        (t._showElement = function (t) {
          ...
          (this._element.parentNode &&
            ...
            p(this._dialog).hasClass(on)
              ? (this._dialog.querySelector(hn).scrollTop = 0)
    ...
    Ci = (function () {
      function i(t, e) {
        ...
        (this._element = t),
          ...
          p(this._scrollElement).on(ui.SCROLL, function (t) {
            return n._process(t);
          }),
          this.refresh(),
          this._process();
      ...
      return (
        ...
        (t._getConfig = function (t) {
          if (
            "string" !=
            typeof (t = l({}, li, "object" === _typeof(t) && t ? t : {})).target
          ) {
        ...
        (t._activate = function (e) {
          ...
          n.hasClass(hi)
            ...
            p(this._scrollElement).trigger(ui.ACTIVATE, { relatedTarget: e });
        }),
        (t._clear = function () {
          [].slice
            .call(document.querySelectorAll(this._selector))
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var t = p(this).data(ri),
              e = "object" === _typeof(n) && n;
            if (
              (t || ((t = new i(this, e)), p(this).data(ri, t)),
              "string" == typeof n)
            ) {
              if (void 0 === t[n])
                throw new TypeError('No method named "' + n + '"');
      ...
      return (
        ...
        (o._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (e || ((e = new o(this, n)), t.data(Bi, e)), "string" == typeof i)
            ) {
              if (void 0 === e[i])
                throw new TypeError('No method named "' + i + '"');
              e[i](this);
